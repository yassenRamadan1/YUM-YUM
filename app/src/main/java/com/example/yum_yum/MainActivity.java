    ...
    private void setupUI() {
        ...
        if (navHostFragment != null) {
            ...
            navController.addOnDestinationChangedListener((controller, destination, arguments) -> {
                ...
                if (id == R.id.welcomeScreen || id == R.id.loginScreen || id == R.id.registerFragment|| id == R.id.mealDetailsScreen|| id == R.id.profileFragment || id == R.id.exploreFragment || id == R.id.filteredMealsFragment) {
